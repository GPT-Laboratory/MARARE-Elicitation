...
export const upgradeItem = createAsyncThunk("stories/upgradeItem", async (data, { rejectWithValue }) => {
  ...
  try {
    const response = await fetch(`${socketURL}/upgrade_story`, {
      method: "POST",
      headers: {
...
export const updateItem = createAsyncThunk(
  ...
  async (formData, { rejectWithValue }) => {
    try {
      const response = await fetch(`${socketURL}/update_story`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
        },
...
export const deleteItem = createAsyncThunk("stories/deleteItem", async (_id, { rejectWithValue }) => {
  try {
    const response = await fetch(`${socketURL}/delete-user-story/${_id}`, {
      method: "DELETE",
    });
